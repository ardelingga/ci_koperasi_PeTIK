        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card" id="cetakArea">
                    ...
                    <!-- <a class="btn btn-success btn-md" href="<?=base_url('belanja/tambah');?>"> Tambah Data Baru</a></td> -->
                            ...
                            <tbody>
                                ...
                                foreach($belanja as $belanja){ 
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$belanja->total_belanja;?></td>
                                        <td>
                                            <a class="btn btn-warning" href="<?= base_url('belanja/edit/'.$belanja->id_belanja)?>">Edit</a>
