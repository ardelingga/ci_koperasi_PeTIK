<section class="content">
        ...
        // FORM OPEN
        echo form_open(base_url('belanja/edit/'.$belanja->id_belanja), $atribut);
        ?>
                            ...
                            <form class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <select name="barang_id" class="form-control show-tick">
                                                    <option value="<?php echo $belanja->barang_id ?>"><?php echo $belanja->nama_barang ?>
                                                    </option>
                                                    <?php 
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="jumlah" type="text" class="form-control" placeholder="Jumlah" value="<?php echo $belanja->jumlah ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="tanggal" type="text" class="form-control" placeholder="Tanggal" value="<?php echo $belanja->tanggal ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="total_belanja" type="text" class="form-control" placeholder="Total belanja" value="<?php echo $belanja->total_belanja ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
