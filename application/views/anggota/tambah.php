<section class="content">
        ...
        // FORM OPEN
        echo form_open(base_url('anggota/tambah'), $atribut);
        ?>
                            ...
                            <form class="form-horizontal" action="<?=base_url('anggota/tambah');?>" method="post">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="asal_daerah" type="text" class="form-control" placeholder="Asal Daerah" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="kelompok_kamar" type="text" class="form-control" placeholder="Kelompok Kamar" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="sisa_saldo" type="text" class="form-control" placeholder="Sisa Saldo" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
