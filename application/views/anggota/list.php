        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card" id="cetakArea">
                    ...
                    <a class="btn btn-success btn-md" href="<?=base_url('anggota/tambah');?>"> Tambah Data Baru</a></td>
                            ...
                            <tbody>
                                ...
                                foreach($anggota as $anggota){ 
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$anggota->asal_daerah;?></td>
                                        <td><?=$anggota->kelompok_kamar;?></td>
                                        <td><?=$anggota->sisa_saldo;?></td>
                                        <td>
                                            <a class="btn btn-warning" href="<?= base_url('anggota/edit/'.$anggota->id_anggota)?>">Edit</a>
