<section class="content">
        <div class="container-fluid">
            ...
            // FORM OPEN
            echo form_open(base_url('transaksi/tambah'), $atribut);
            ?> 
                            ...
                            <form class="form-horizontal" action="<?=base_url('anggota/tambah');?>" method="post">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="jumlah" id="jumlah" type="text" placeholder="Jumlah Produk" class="form-control"  value="" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="harga_satuan" id="harga_jual" type="text" class="form-control" placeholder="Harga Produk" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <select name="petugas_id" id="petugas_id" class="form-control show-tick">
                                                    <option value="">-- Pilih nama petugas --</option>
                                                    <?php 
                                                        foreach ($petugas as $petugas) {
                                                        echo '<option value="'.$petugas->id_petugas.'" name="anggota_id">'.$petugas->nama_petugas.'</option>';
                                                        }
                                                    ?>
                                                </select>
    ...
    <script type="text/javascript"> 
      ...
      string += "<option> Pilih produk </option>";
      ...
      barang_id.addEventListener('change', (event) => {
        harga_jual.value = result[barang_id.selectedIndex-1].harga_jual;
      });

      jumlah.addEventListener('change', (event) =>{
        total_harga.value = jumlah.value * harga_jual.value;
      });
