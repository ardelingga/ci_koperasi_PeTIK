<section class="content">
        ...
        // FORM OPEN
        echo form_open(base_url('transaksi/edit/'.$transaksi->id_transaksi), $atribut);
        ?>
                            ...
                            <form class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <select name="anggota_id" class="form-control show-tick">
                                                    <option value="<?php echo $transaksi->anggota_id ?>"><?php echo $transaksi->nama_anggota ?></option>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <select name="barang_id" class="form-control show-tick">
                                                    <option value="<?php echo $transaksi->barang_id ?>"><?php echo $transaksi->nama_barang ?></option>
                                                    <?php 
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="jumlah" type="text" class="form-control" placeholder="Jumlah" value="<?php echo $transaksi->jumlah ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="harga_satuan" type="text" class="form-control" placeholder="Harga Satuan" value="<?php echo $transaksi->harga_satuan ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="total_harga" type="text" class="form-control" placeholder="Total Harga" value="<?php echo $transaksi->total_harga ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="tanggal" type="text" class="form-control" placeholder="Total Harga" value="<?php echo $transaksi->tanggal ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <select name="petugas_id" class="form-control show-tick">
                                                    <option value="<?php echo $transaksi->petugas_id ?>"><?php echo $transaksi->nama_petugas ?></option>
                                                    <?php 
                                                        foreach ($petugas as $row_kebutuhan) {
                                                        echo '<option value="'.$row_kebutuhan->id_petugas.'" name="barang_id">'.$row_kebutuhan->nama_petugas.'</option>';
                                                        }
                                                    ?>
                                                </select>
                                                <?php 
