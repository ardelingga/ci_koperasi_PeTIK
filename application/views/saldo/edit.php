<section class="content">
        ...
        // FORM OPEN
        echo form_open(base_url('saldo/edit/'.$saldo->id), $atribut);
        ?>
                            ...
                            <form class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <select name="anggota_id" class="form-control show-tick">
                                                    <option value="<?php echo $saldo->anggota_id ?>"><?php echo $saldo->nama_anggota ?></option>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <select name="barang_id" class="form-control show-tick">
                                                    <option value="<?php echo $saldo->barang_id ?>"><?php echo $saldo->nama_barang ?></option>
                                                    <?php 
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="jumlah" type="text" class="form-control" placeholder="Jumlah" value="<?php echo $saldo->jumlah ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="harga_satuan" type="text" class="form-control" placeholder="Harga Satuan" value="<?php echo $saldo->harga_satuan ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="total_harga" type="text" class="form-control" placeholder="Total Harga" value="<?php echo $saldo->total_harga ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
