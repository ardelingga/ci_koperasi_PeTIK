        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card" id="cetakArea">
                    ...
                    <!-- <a class="btn btn-success btn-md" href="<?=base_url('daftar_kebutuhan/tambah');?>"> Tambah Data Baru</a></td> -->
                    ...
                    <div class="body table-responsive">
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                <?php                                   
                                $i = 1; 
                                foreach($daftar_kebutuhan as $daftar_kebutuhan){ 
                                    ?>
                                    <tr>
                                        <th scope="row"><?=$i;?></th>
                                        <td><?=$daftar_kebutuhan->nama_anggota;?></td>
                                        <td><?=$daftar_kebutuhan->nama_barang;?></td>
                                        <td><?=$daftar_kebutuhan->jumlah;?></td>
                                        <td><?=$daftar_kebutuhan->harga_satuan;?></td>
                                        <td><?=$daftar_kebutuhan->total_harga;?></td>
                                        <td>
                                            <a class="btn btn-warning" href="<?= base_url('daftar_kebutuhan/edit/'.$daftar_kebutuhan->id_daftar_kebutuhan)?>">Edit</a>
