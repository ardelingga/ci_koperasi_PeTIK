<section class="content">
        ...
        // FORM OPEN
        echo form_open(base_url('daftar_kebutuhan/edit/'.$daftar_kebutuhan->id_daftar_kebutuhan), $atribut);
        ?>
                            ...
                            <form class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <select name="anggota_id" class="form-control show-tick">
                                                    <option value="<?php echo $daftar_kebutuhan->anggota_id ?>"><?php echo $daftar_kebutuhan->nama_anggota ?></option>
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <select name="barang_id" class="form-control show-tick">
                                                    <option value="<?php echo $daftar_kebutuhan->barang_id ?>"><?php echo $daftar_kebutuhan->nama_barang ?></option>
                                                    <?php 
                                                        foreach ($barang as $row_kebutuhan) {
                                                        echo '<option value="'.$row_kebutuhan->id_barang.'" name="barang_id">'.$row_kebutuhan->nama_barang.'</option>';
                                                        }
                                                    ?>
                                                </select>
                                                <?php 
                                                // var_dump($daftar_kebutuhan);
                                                // exit();
                                                ?>
                                            </div>
                                        </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="jumlah" type="text" class="form-control" placeholder="Jumlah" value="<?php echo $daftar_kebutuhan->jumlah ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="harga_satuan" type="text" class="form-control" placeholder="Harga Satuan" value="<?php echo $daftar_kebutuhan->harga_satuan ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="total_harga" type="text" class="form-control" placeholder="Total Harga" value="<?php echo $daftar_kebutuhan->total_harga ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
