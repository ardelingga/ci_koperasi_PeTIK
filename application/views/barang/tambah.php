<section class="content">
        ...
        // FORM OPEN
        echo form_open(base_url('barang/tambah'), $atribut);
        ?>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">                          
                            <form class="form-horizontal" action="<?=base_url('barang/tambah');?>" method="post">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="nama_barang" type="text" class="form-control" placeholder="Nama Produk" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="harga_barang" type="text" class="form-control" placeholder="Harga Produk" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="stok_barang" type="text" class="form-control" placeholder="Stok Produk" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
