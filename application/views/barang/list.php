        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card" id="cetakArea">
                    ...
                    <a class="btn btn-success btn-md" href="<?=base_url('barang/tambah');?>"> Tambah Data Baru</a></td>
                            ...
                            <tbody>
                                ...
                                foreach($barang as $barang){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning" href="<?= base_url('barang/edit/'.$barang->id_barang)?>">Edit</a>
