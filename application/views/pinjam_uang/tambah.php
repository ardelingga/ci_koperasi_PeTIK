<section class="content">
        <div class="container-fluid">
            ...
            // FORM OPEN
            echo form_open(base_url('pinjam_uang/tambah'), $atribut);
            ?> 
                            ...
                            <form class="form-horizontal" action="<?=base_url('anggota/tambah');?>" method="post">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="tanggal" id="jumlah" type="date" class="form-control"  value="" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="jumlah" id="jumlah" type="text" class="form-control" placeholder="Jumlah"  value="" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
