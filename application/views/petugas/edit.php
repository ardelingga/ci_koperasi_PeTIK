<section class="content">
        ...
        // FORM OPEN
        echo form_open(base_url('petugas/edit/'.$petugas->id_petugas), $atribut);
        ?>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">                          
                            <form class="form-horizontal" action="<?= base_url('petugas/edit/'.$petugas->id_petugas)?>" method="post">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="nama_petugas" type="text" class="form-control" placeholder="Nama Petugas" value="<?php echo $petugas->nama_petugas ?>" required>
                                            </div>
                                            <?php 
                                                // var_dump($petugas);
                                                // exit();
