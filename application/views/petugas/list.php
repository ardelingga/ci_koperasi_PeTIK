        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card" id="cetakArea">
                    ...
                    <a class="btn btn-success btn-md" href="<?=base_url('petugas/tambah');?>"> Tambah Data Baru</a></td>
                            ...
                            <tbody>
                                ...
                                foreach($petugas as $petugas){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning" href="<?= base_url('petugas/edit/'.$petugas->id_petugas)?>">Edit</a>
