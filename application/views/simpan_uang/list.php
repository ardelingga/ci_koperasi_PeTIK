        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card" id="cetakArea">
                    ...
                    <!-- <a class="btn btn-success btn-md" href="<?=base_url('simpan_uang/tambah');?>"> Tambah Data Baru</a></td> -->
                    ...
                    <div class="body table-responsive">
                        <table class="table table-condensed">
                            ...
                            <tbody>
                                <?php                                   
                                $i = 1; 
                                foreach($simpan_uang as $simpan_uang){ 
                                    ?>
                                    <tr>
                                        <th scope="row"><?=$i;?></th>
                                        <td><?=$simpan_uang->nama_anggota;?></td>
                                        <td><?=$simpan_uang->tanggal;?></td>
                                        <td><?=$simpan_uang->jumlah;?></td>
                                        <td>
                                            <a class="btn btn-warning" href="<?= base_url('simpan_uang/edit/'.$simpan_uang->id_simpan)?>">Edit</a>
