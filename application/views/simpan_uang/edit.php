<section class="content">
        ...
        // FORM OPEN
        echo form_open(base_url('simpan_uang/edit/'.$simpan_uang->id_simpan), $atribut);
        ?>
                            ...
                            <form class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <select name="anggota_id" class="form-control show-tick">
                                                    <option value="<?php echo $simpan_uang->anggota_id ?>"><?php echo $simpan_uang->nama_anggota ?></option>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="tanggal" type="date" class="form-control" placeholder="Tanggal" value="<?php echo $simpan_uang->tanggal ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input name="jumlah" type="text" class="form-control" placeholder="Jumlah" value="<?php echo $simpan_uang->jumlah ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
